    ...
    return Scaffold(
      ...
      bottomNavigationBar: CupertinoTabBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: Icon(Icons.add_circle_outline_outlined,  color: _page == 2 ? primaryColor : secondaryColor,),
            label : "",
            backgroundColor: primaryColor
          ),
          BottomNavigationBarItem(
          ...
          BottomNavigationBarItem(
            icon: Icon(Icons.settings,  color: _page == 4 ? primaryColor : secondaryColor,),
            label : "",
            backgroundColor: primaryColor
          ),
        ],
